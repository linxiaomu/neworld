...
![idea设置](./images/springboot01.png)
...
2、打开一个网站[https://www.bootschool.net/ascii](https://www.bootschool.net/ascii)，生成艺术字

3、将生成的艺术字，复制粘贴到banner.txt文件中，springboot识别就好啦。
...
–file:./config/                           就是指整个项目下的位置

–file:./                                        就是指整个项目下的位置

–classpath:/config/                  resources文件夹下
...
![images/concrete-bindings.png](./images/springboot05.png)
...
![](./images/springboot21.png)

2）、EmbeddedServletContainer：（嵌入式的Servlet容器）

![](./images/springboot22.png)
...
​	默认是用~~org.apache.tomcat.jdbc.pool.DataSource~~（现在使用后面的数据源）

class com.zaxxer.hikari.HikariDataSource作为数据源；
